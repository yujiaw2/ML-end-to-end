...
@patch("app.main.predict", return_value=4.26)
...
@patch("app.main.predict_batch", return_value=[4.26, 3.75])
...
@patch("app.main.predict", return_value=4.26579)
...
@patch("app.main.predict_batch", return_value=[4.26579, 3.75166])
